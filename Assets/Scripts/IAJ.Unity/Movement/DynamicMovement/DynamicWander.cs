...
namespace Assets.Scripts.IAJ.Unity.Movement.DynamicMovement
{
    ...
    public class DynamicWander : DynamicSeek
    {
        ...
        public override MovementOutput GetMovement()
        {
            ...
            this.CircleCenter = this.Character.Position + this.WanderOffset * Character.GetOrientationAsVector();
            this.Target.Position = this.CircleCenter + this.WanderRadius * MathHelper.ConvertOrientationToVector(targetOrientation);
